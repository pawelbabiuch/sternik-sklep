...
import pl.sternik.pb.sklep.book.*;
...
public class RunSklep {
	...
	public static void main(String[] args) {//throws BadArticleIDException {
		...
		Article dvd = new Article(2, "Shameless S01", "Serial paradoksalny", 29.99, new Date());
		System.out.println(dvd);
		Article dvd2 = new Article(3, "Aterix", "Serial Panoramixsalny", 19.99, new Date());
